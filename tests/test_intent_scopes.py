...
class TestDetectScope:
    ...
    @patch("assistant.intent_scopes._get_browser_driver_available", return_value=True)
    ...
    def test_a_connected_browser_returns_browser_mode(self, _cam, _rec, _driver):
    ...
    @patch("assistant.intent_scopes._get_browser_driver_available", return_value=False)
    @patch("assistant.intent_scopes._get_recording_active", return_value=True)
    @patch("assistant.intent_scopes._get_camera_pending", return_value=False)
    def test_recording_active_returns_recording_mode(self, _cam, _rec, _driver):
        detect_scope = self._get_detect_scope()
        scope_name, intents = detect_scope(turn_number=1)
    ...
    def test_camera_pending_returns_camera_mode(self, _cam, _rec, _driver):
        detect_scope = self._get_detect_scope()
        scope_name, intents = detect_scope(turn_number=1)
    ...
    @patch("assistant.intent_scopes._get_recording_active", return_value=False)
    @patch("assistant.intent_scopes._get_camera_pending", return_value=False)
    def test_nothing_active_returns_general(self, _cam, _rec, _driver):
        detect_scope = self._get_detect_scope()
        scope_name, intents = detect_scope(turn_number=1)
...
class TestStickyScope:
    ...
    @patch("assistant.intent_scopes._get_browser_driver_available")
    @patch("assistant.intent_scopes._get_recording_active", return_value=False)
    @patch("assistant.intent_scopes._get_camera_pending", return_value=False)
    def test_sticky_persists_two_turns(self, _cam, _rec, mock_driver):
    ...
    @patch("assistant.intent_scopes._get_recording_active", return_value=False)
    @patch("assistant.intent_scopes._get_camera_pending", return_value=False)
    def test_sticky_decays_after_two_turns(self, _cam, _rec, _driver):
        mod = self._get_module()
